...
// 获取容器详情
export const getContainerDetailApi = (id: string) =>
...
// 获取容器资源使用情况
export const getContainerUsageApi = (id: string) => {
  return request.get(`docker/{host}/containers/usage`, { id });
};

// 追踪容器资源使用情况
export function connectContainerUsageFollowApi(id: string): EventSource {
  const url = resolveApiUrl(`docker/{host}/containers/usage/follow`, { id });
...
// prune
export const pruneApi = (params: PruneParams) =>
