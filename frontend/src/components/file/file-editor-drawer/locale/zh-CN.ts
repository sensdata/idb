export default {
  ...
  'app.file.editor.modeReadOnly': '只读模式',
  'app.file.editor.modeEditing': '编辑模式',
  'app.file.editor.modeReadOnlyHint': '当前只读，双击编辑区内容可进入编辑模式',
  'app.file.editor.modeEditingHint': '当前可编辑，修改后请点击保存',
