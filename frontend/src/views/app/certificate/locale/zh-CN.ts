export default {
  ...
  'app.certificate.viewCertificates': '查看证书列表',
  'app.certificate.completeChain': '补齐证书链',
  'app.certificate.deleteGroup': '删除证书组',
  'app.certificate.deleteCertificate': '删除证书',
  ...
  'app.certificate.chainStatus': '证书链',
  ...
  'app.certificate.chainStatus.completed': '已补齐',
  'app.certificate.chainStatus.incomplete': '未补齐',
  'app.certificate.chainStatus.unknown': '未知',
  ...
  'app.certificate.copySourcePath': '复制证书路径',
  ...
  'app.certificate.copyPrivateKeyPath': '复制私钥路径',
  'app.certificate.csrContent': 'CSR内容（PEM格式）',
  'app.certificate.copyCSR': '复制CSR',
  'app.certificate.csrUnavailable': '暂无CSR内容',
  ...
  'app.certificate.pathUnavailable': '暂无可复制的路径',
