export default {
  ...
  'app.logrotate.list.column.source_status': '来源状态',
  'app.logrotate.list.column.updated_at': '更新时间',
  'app.logrotate.list.status.active': '已启用',
  'app.logrotate.list.status.inactive': '未启用',
  'app.logrotate.list.source_status.package_pristine': '系统自带',
  'app.logrotate.list.source_status.package_modified': '系统文件已改',
  'app.logrotate.list.source_status.package_owned': '系统包文件',
  'app.logrotate.list.source_status.local': '用户新增',
  'app.logrotate.list.source_status.unknown': '来源未知',
  'app.logrotate.list.source_package': '所属软件包：{package}',
