export default {
  ...
  'app.logrotate.enum.type.system': '系统轮转状态',
  ...
  'app.logrotate.list.column.status': '启用状态',
  'app.logrotate.list.column.updated_at': '更新时间',
  'app.logrotate.list.status.active': '已启用',
  'app.logrotate.list.status.inactive': '未启用',
  'app.logrotate.list.operation.activate': '启用',
  ...
  'app.logrotate.list.message.activate_success': '启用配置成功',
  'app.logrotate.list.message.activate_failed': '启用配置失败',
