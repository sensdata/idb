export default {
  ...
  'app.logrotate.list.column.source_status': 'Source Status',
  ...
  'app.logrotate.list.source_status.package_pristine': 'System Default',
  'app.logrotate.list.source_status.package_modified': 'Modified Default',
  'app.logrotate.list.source_status.package_owned': 'Package Managed',
  'app.logrotate.list.source_status.local': 'User Added',
  'app.logrotate.list.source_status.unknown': 'Unknown',
  'app.logrotate.list.source_package': 'Package: {package}',
