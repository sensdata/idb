...
func (s *SettingsService) getAgentRuntimeStatus(host db.Host) (*model.AgentRuntimeStatus, error) {
	...
	status := &model.AgentRuntimeStatus{
		...
		ProcessRSS:         hostStatus.ProcessRSS,
		HeapAlloc:          hostStatus.HeapAlloc,
		HeapSys:            hostStatus.HeapSys,
		StackInuse:         hostStatus.StackInuse,
		Goroutines:         hostStatus.Goroutines,
		OpenFDs:            hostStatus.OpenFDs,
		ActiveSessions:     hostStatus.ActiveSessions,
		ActiveLogFollowers: hostStatus.ActiveLogFollowers,
	}
