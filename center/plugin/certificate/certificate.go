...
func (s *CertificateMan) checkRepo(hostID uint, repoPath string) error {
...
func (s *CertificateMan) getScriptList(hostID uint64, req model.QueryGitFile) (*model.PageResult, error) {
...
func (s *CertificateMan) getScriptDetail(hostID uint64, req model.GetGitFileDetail) (*model.GitFile, error) {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) create(hostID uint64, req model.CreateGitFile) error {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) update(hostID uint64, req model.UpdateGitFile) error {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) delete(hostID uint64, req model.DeleteGitFile) error {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) restore(hostID uint64, req model.RestoreGitFile) error {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) getScriptLog(hostID uint64, req model.GitFileLog) (*model.PageResult, error) {
	var pageResult = model.PageResult{Total: 0, Items: nil}
...
func (s *CertificateMan) getScriptDiff(hostID uint64, req model.GitFileDiff) (string, error) {
	var repoPath string
	switch req.Type {
	case "global":
		repoPath = filepath.Join(s.pluginConf.Items.WorkDir, "global")
...
func (s *CertificateMan) execute(hostID uint64, req model.ExecuteScript) (*model.ScriptResult, error) {
...
func (s *CertificateMan) getScriptRunLog(hostID uint64) (string, error) {
