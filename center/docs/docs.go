...
const docTemplate = `{
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.AddServerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.GetServersResponse"
                        }
                    }
                }
            }
        ...
        "/sysinfo/{host}/action/memcache/auto/set": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Auto clear interval settings",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.AutoClearMemCacheReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/sysinfo/{host}/action/memcache/clear": {
            "post": {
        ...
        "/sysinfo/{host}/action/swap/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create swap settings",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateSwapReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/sysinfo/{host}/action/swap/delete": {
            "post": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateDnsSettingsReq"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateSystemSettingsReq"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SetTimeReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/sysinfo/{host}/action/upd/timezone": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SetTimezoneReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.GetServersResponse": {
            "type": "object",
            "properties": {
                "servers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.PmaServerInfo"
                    }
                },
                "total": {
                    "type": "integer"
