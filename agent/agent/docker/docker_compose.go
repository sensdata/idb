...
// 		return "", err
// 	}
// 	global.LOG.Info("docker-compose.yml %s create successful, start to docker-compose up", req.Name)
...
// 	global.LOG.Info("docker-compose.yml %s has been replaced, now start to docker-compose restart", req.Path)
